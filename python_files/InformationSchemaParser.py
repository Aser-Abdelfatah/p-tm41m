...
class DatabaseDDLGenerator:
    ...
    def marshal_ddl_statements(self):
        ...
        self.marshalled_ddl_statements = json.dumps(self.ddl_statements)
    ...
    def print_marshalled_ddl_statements(self):
        print(self.marshalled_ddl_statements)
...
if __name__ == "__main__":
    ...
    ddl_generator.generate_ddl_statements()
    ddl_generator.marshal_ddl_statements()  # Serialize to JSON
    ddl_generator.unmarshal_ddl_statements()  # Deserialize back to Python objects
